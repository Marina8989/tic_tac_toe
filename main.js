...
(function() {
  ...
  var highlightPlaya = function(playaOn, playaOff) {
    playaOn.style.boxShadow =
      "10px 10px 10px rgba(245,245,245,0.7) inset, -10px -10px 10px rgba(245,245,245,0.7) inset, 5px 5px 7px rgba(50,50,50,0.7)";
  ...
  var cheers = [
    "Now you may take your opponents skull as a trophy!",
    "You are the baddest cat in town!",
    "Your Kung Fu is legendary!",
    "It's not fair how cool you are!",
    "Because of your awesome skill, you have been unanimously elected as supreme overloard of the entire multi-verse!"
  ];
